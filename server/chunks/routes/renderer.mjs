...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"A music app built with Nuxt.js"},{"name":"theme-color","content":"#000000"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/Logo.png"}],"style":[],"script":[],"noscript":[],"title":"170 39"};
